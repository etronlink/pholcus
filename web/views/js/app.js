// websocket
var httpsTag = 'https:' == document.location.protocol ? true : false;
var wsUri = "ws://" + location.hostname + ":" + location.port + "/ws";
if (httpsTag) {
    wsUri = "wss://" + location.hostname + ":" + location.port + "/ws";
}
var ws = null;
var wsLogUri = "ws://" + location.hostname + ":" + location.port + "/ws/log";
if (httpsTag) {
    wsLogUri = "wss://" + location.hostname + ":" + location.port + "/ws/log";
}
var wslog = null;
